...
function setup()
  return {
    properties = {
      max_speed_for_map_matching      = 100/3.6, -- 100kmph -> m/s
    ...
    vehicle_width = 2.7, -- in meters, ways with narrow tag are considered narrower than 2.2m

    -- Size of the vehicle, to be limited mostly by legal restriction of the way
    vehicle_length = 6, -- in meters, 4.8m is the length of large or family car
    vehicle_weight = 20000, -- in kilograms #TODO: min 17 - max 28 tons
